...
Como clave del registro puede utilizar lo que quiera, ya que es sólo una clave, pero aquí
hemos elegido usar el noñbre de uno de los autores y el año: comunmente se hace esta elección.

Los campos que necesite especificar dependerá del tipo de registro, pero la mayoría de
...
Edidar manualmente los archivos `.bib` es bastante tedioso, por ello la mayoría de la gente
...
base de datos, selecciones las que usted use y las ordene. En último lugar, 
...
El formato de las citas y las referecias es independiente de su base de datos BibTeX y
...
la(s) base(s) de datos usada(s); si son varias, sus nonbres son separados por comas.
...
La configuración de nuestro ejemplo utiliza el formato autor-año estilo, pero podemos
...
que aunque las citas aparecen en el cuerpo del documento, las bases de datos se 
seleccionan en el preámbulo. Existen algunos comandos para hacer esto.
...
ejecutar LaTeX, luego BibTeX, LaTeX y LaTeX; con `biblatex` deberá ejecutar LaTeX,
