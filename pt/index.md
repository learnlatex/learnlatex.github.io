...
## Welcome to learnlatex.org (Portuguese)!
...
[Lesson 2](pt/lesson-02) we will talk about how you use LaTeX both online and with
...
examples [in the site help](pt/help).
...
### Additional lessons specific to learnlatex.org/pt
...
lesson](pt/lesson-15), but it's worth saying now that getting access to a book
