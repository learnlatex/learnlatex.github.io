...
[Comme vu plus haut](lesson-02), les documents LaTeX sont simplement du texte
...
verrez le même texte que dans un éditeur LaTeX dédié, mais sans aucune mise en
couleur des mots-clefs.

Vous pouvez également compiler votre document LaTeX en PDF sans votre éditeur ;
...
supposera que les fichiers se terminent par `.tex`, sauf indication contraire
de votre part.
