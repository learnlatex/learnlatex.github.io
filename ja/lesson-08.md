...
さらに，少しですが列を作成しないプリアンブル・トークンもあり，これらもやはり有益です．
...
上の2つの表に記載のもので，LaTeX 本体および `array` パッケージが提供するプリアンブル・トークンはすべてです．[追加レッスン](more-08)では，他のパッケージが提供するもういくつかの拡張プリアンブル・トークンを紹介しています．
...
<!-- TODO: 和文主体の文書では，罫線はそこまで嫌われていない．この旨を注釈するか？ -->
